...
/**
 * External API: queue an ad-hoc task to generate an AI quiz for a GCS recording.
 *
 * @package    mod_jitsi
 * @category   external
 ...
 */
class queue_ai_quiz extends external_api {
    /**
    ...
    /**
     * Queue an ad-hoc task to generate an AI quiz for a GCS recording.
     *
