...
/**
 * External API: register a Web Push subscription for the current user.
 *
 * @package    mod_jitsi
 * @category   external
 ...
 */
class register_push_subscription extends external_api {
    /**
     ...
     * @return array
     */
    public static function execute($endpoint, $authkey, $p256dhkey) {
        global $DB, $USER;
