...
/**
 * External API: audit event when the user presses the microphone button.
 *
 * @package    mod_jitsi
 * @category   external
 ...
 */
class press_button_microphone extends external_api {
    /**
    ...
    /**
     * Trigger the microphone button audit event.
     *
