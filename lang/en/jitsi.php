...
$string['recordingoptionex'] = '<b>Jitsi interface</b> keeps the native recording button inside Jitsi, where its dialog lets users choose between the 8x8 recording service and their own Dropbox. <b>Moodle integrated</b> replaces it with a one-click record button in the Moodle toolbar above the meeting that always records to the 8x8 recording service (recordings are saved in the activity automatically). Only applies to 8x8/JaaS (type 2) servers.';
