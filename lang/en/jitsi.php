...
$string['tokeninvitacion_help'] = 'Search by activity name, course name or shortname and select the session you want to join. Students from this course will enter the same room as that session.';
