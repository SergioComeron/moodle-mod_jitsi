...
$string['actaactionitems'] = 'Pending follow-ups';
$string['actaactionitemsnone'] = 'No pending follow-ups were identified.';
$string['actaapiendpoint'] = 'LLM API endpoint';
$string['actaapiendpointex'] = 'OpenAI-compatible base URL (for example https://api.openai.com/v1). /chat/completions is added automatically if missing. Used only for session minutes.';
$string['actaapikey'] = 'LLM API key (BYOK)';
$string['actaapikeyactivity'] = 'Session minutes API key (optional)';
$string['actaapikeyactivity_help'] = 'Optional OpenAI-compatible API key for this activity, used only when Vertex AI is not already configured on the site. If set, it is used instead of the site key. Leave empty to keep the stored key or inherit the site key.';
$string['actaapikeyex'] = 'Used when the site does not already have Vertex AI configured. Your own OpenAI-compatible API key. The plugin never uses a vendor-paid key. If Vertex is configured it is used instead; this key stays as fallback. The key is never written to logs.';
$string['actaapimodel'] = 'LLM model';
$string['actaapimodelex'] = 'Model name sent to the OpenAI-compatible API (default gpt-4o-mini).';
$string['actaattendance'] = 'Attendance';
$string['actaempty'] = 'No session minutes yet. They are generated when a teacher hangs up, or you can generate them from the latest attendance window.';
$string['actaenabled'] = 'Enable session minutes (acta)';
$string['actaenabledex'] = 'When enabled, hanging up a session queues session minutes: a short summary, attendance from the existing participating logs, and pending follow-ups. Uses the site Vertex AI setup if it is already configured; otherwise the OpenAI-compatible key below (site or activity). If neither is available, meetings work as before and no minutes are generated. Recordings are not uploaded; a stored transcript is used when one already exists.';
$string['actaerror'] = 'Session minutes could not be generated. Attendance is still stored when available.';
$string['actagenerate'] = 'Generate minutes from last session';
$string['actagenerating'] = 'Session minutes are being generated…';
$string['actaheading'] = 'Session minutes (acta)';
$string['actaheadingex'] = 'Session minutes after hang-up. If Vertex AI is already configured on this site it is used automatically; otherwise the BYOK key below. No provider selector, billing or marketplace.';
$string['actallmempty'] = 'The LLM returned an empty reply.';
$string['actallmhttp'] = 'The LLM returned HTTP {$a}.';
$string['actallmjson'] = 'The LLM reply was not valid JSON.';
$string['actallmtransport'] = 'Could not reach the LLM endpoint.';
$string['actanotavailable'] = 'Session minutes are off because neither Vertex AI nor a BYOK key is available.';
$string['actaprivacynote'] = 'Minutes use existing attendance logs. If a transcript already exists it is sent to Vertex AI when that is configured, otherwise to your BYOK LLM; recordings are not uploaded.';
$string['actaqueued'] = 'Session minutes were queued. They will appear here shortly.';
$string['actashow'] = 'Show session minutes on this activity';
$string['actashow_help'] = 'If enabled, people who can view session minutes will see the acta on this activity. Uncheck to hide it here (including for teachers). Minutes can still be generated when a teacher hangs up; they appear once this is checked again.';
$string['actasource_metadata'] = 'Generated from attendance only (no transcript)';
$string['actasource_transcript'] = 'Generated from the session transcript';
$string['actasummary'] = 'Summary';
$string['actasummaryunavailable'] = 'No summarisable session content was available.';
$string['actatitle'] = 'Session minutes';
...
$string['aigenerationfailed'] = 'The AI generation for this recording failed. Please try again.';
...
$string['aiquizqueued'] = 'AI quiz generation queued. It will appear here automatically in a few minutes.';
...
$string['aisummaryqueued'] = 'AI summary generation queued. It will appear here automatically in a few minutes.';
...
$string['aitranscriptionqueued'] = 'AI transcription queued. It will appear here automatically in a few minutes.';
...
$string['coursedashboardminutes'] = 'Minutes';
$string['coursedashboardnodata'] = 'No session data available yet.';
$string['coursedashboardnorecordingdata'] = 'No recording view data available yet.';
$string['coursedashboardparticipants'] = 'Unique participants';
$string['coursedashboardrecording'] = 'Recording';
$string['coursedashboardrecordings'] = 'Recordings';
$string['coursedashboardrecordingsstarted'] = 'Recordings started';
$string['coursedashboardsessions'] = 'Sessions';
$string['coursedashboardstudents'] = 'Student engagement';
$string['coursedashboardtoprecordings'] = 'Top recordings by viewers';
$string['coursedashboardviewers'] = 'Viewers';
...
$string['dropboxwith8x8'] = 'With an 8x8/JaaS server these credentials power the "Record to Dropbox" button shown next to the Moodle record button (requires the recording button setting "Moodle integrated"). Register this additional redirect URI in your Dropbox app: <code>{$a}</code>';
...
$string['guestjoin'] = 'Join session';
$string['guestname'] = 'Your name';
$string['guestnamePlaceholder'] = 'Enter the name to display in the session';
$string['hasentered'] = 'has entered on your private Jitsi session';
$string['heatmapbucketnoviewers'] = 'No viewers for this segment.';
$string['heatmapbucketviewers'] = 'Viewers of {start}s–{end}s:';
$string['help'] = 'Help';
...
$string['inviteemail'] = 'Send invitation by email';
$string['inviteemailex'] = 'Allow teachers to send the invitation link directly by email from the session page.';
...
$string['jitsi:generateaiquiz'] = 'Generate AI quiz from recordings';
$string['jitsi:generateaisummary'] = 'Generate AI summary from recordings';
$string['jitsi:generateaitranscription'] = 'Generate AI transcription from recordings';
...
$string['jitsi:viewacta'] = 'View session minutes';
...
$string['portalopensourcenote'] = '<strong>mod_jitsi is open source.</strong> Anyone can modify the code and remove the registration requirement — we know that. Registration is not about locking features for commercial reasons. It exists purely so the developer can see which Moodle versions, server types and features are actually used, and focus work where it matters most.';
...
$string['portalrequiredcontactadmin'] = 'This feature requires a mod_jitsi Account. Please contact your site administrator to enable it.';
$string['portalresendemail'] = 'Resend email';
$string['portalstatusactive'] = 'Connected to mod_jitsi Account';
...
$string['privacy:metadata:actallm'] = 'When session minutes are enabled and Vertex AI is not configured, a session transcript (if one already exists) and attendance display names are sent to the configured OpenAI-compatible BYOK endpoint. Recordings are not uploaded. The site or activity owner supplies the key; no vendor-paid key is used.';
$string['privacy:metadata:actallm:attendance'] = 'Display names and connected minutes of attendees, used so the minutes can list who was present.';
$string['privacy:metadata:actallm:transcript'] = 'Existing session transcript text, when one has already been stored for the same session window.';
...
$string['privacy:metadata:jitsi_push_subscriptions:p256dhkey'] = 'The P-256 Diffie-Hellman public key for the push subscription (base64url-encoded).';
$string['privacy:metadata:jitsi_push_subscriptions:userid'] = 'The ID of the Moodle user who registered the push subscription.';
$string['privacy:metadata:jitsi_recording_segments'] = 'Watched video segments tracking which parts of a GCS recording each user has viewed.';
$string['privacy:metadata:jitsi_recording_segments:playcounts'] = 'JSON array of play counts per 10-second bucket across the recording.';
$string['privacy:metadata:jitsi_recording_segments:segments'] = 'JSON array of [start, end] pairs in seconds representing watched segments.';
$string['privacy:metadata:jitsi_recording_segments:userid'] = 'The ID of the Moodle user who watched the recording.';
$string['privacy:metadata:jitsi_session_acta'] = 'Session minutes generated after a class, including attendance copied from participating logs, the short summary and pending follow-ups.';
$string['privacy:metadata:jitsi_session_acta:actionitems'] = 'JSON list of pending follow-ups extracted from the session.';
$string['privacy:metadata:jitsi_session_acta:attendancejson'] = 'JSON list of attendees (user id, display name and connected minutes) for the session.';
$string['privacy:metadata:jitsi_session_acta:summary'] = 'Short AI-generated summary of the session.';
$string['privacy:metadata:jitsi_session_acta:userid'] = 'The ID of the teacher who ended the session and triggered the minutes.';
...
$string['privacy:metadata:jitsi_tutoring_schedule:timestart'] = 'Start of the availability slot in seconds from midnight (teacher\'s timezone).';
$string['privacy:metadata:jitsi_tutoring_schedule:userid'] = 'The ID of the teacher who configured the availability schedule.';
$string['privacy:metadata:jitsi_tutoring_schedule:weekday'] = 'Day of the week for this availability slot (0 = Sunday, 6 = Saturday).';
$string['privacy:metadata:jitsi_usage_daily'] = 'Pre-computed daily usage aggregates recording the number of sessions and minutes each user spent in each Jitsi activity.';
$string['privacy:metadata:jitsi_usage_daily:minutes'] = 'The total minutes the user spent in sessions on this day.';
$string['privacy:metadata:jitsi_usage_daily:sessions'] = 'The number of sessions the user joined on this day.';
$string['privacy:metadata:jitsi_usage_daily:times'] = 'JSON array of session entry timestamps for this user on this day.';
$string['privacy:metadata:jitsi_usage_daily:userid'] = 'The ID of the Moodle user whose usage is recorded.';
...
$string['privacy:metadata:vertexai'] = 'When a teacher generates an AI summary, quiz or transcription, the video recording is sent to Google Vertex AI (Gemini). When session minutes are enabled and Vertex AI is already configured, an existing transcript (if any) and attendance display names are also sent there — recordings are not uploaded for minutes. The region is configurable in the plugin settings.';
$string['privacy:metadata:vertexai:attendance'] = 'Display names and connected minutes of attendees, sent when session minutes use the existing Vertex AI setup.';
...
$string['privacy:metadata:vertexai:transcript'] = 'Existing session transcript text, sent to Vertex AI when session minutes use the existing Vertex setup. Recordings are not uploaded for minutes.';
...
$string['task_generate_session_acta'] = 'Generate session minutes (acta)';
