...
$string['actaapiendpointex'] = 'OpenAI-compatible base URL (for example https://api.openai.com/v1). /chat/completions is added automatically if missing. Used only for session notes.';
$string['actaapikey'] = 'LLM API key (BYOK)';
$string['actaapikeyactivity'] = 'Session notes API key (optional)';
...
$string['actaempty'] = 'No session notes yet. They are generated when a teacher hangs up, or you can generate them from the latest attendance window.';
$string['actaenabled'] = 'Enable session notes';
$string['actaenabledex'] = 'When enabled, hanging up a session queues session notes: a short summary, attendance from the existing participating logs, and pending follow-ups. Uses the site Vertex AI setup if it is already configured; otherwise the OpenAI-compatible key below (site or activity). If neither is available, meetings work as before and no notes are generated. Recordings are not uploaded; a stored transcript is used when one already exists.';
$string['actaerror'] = 'Session notes could not be generated. Attendance is still stored when available.';
$string['actagenerate'] = 'Generate notes from last session';
$string['actagenerating'] = 'Session notes are being generated…';
$string['actaheading'] = 'Session notes';
$string['actaheadingex'] = 'Session notes after hang-up. If Vertex AI is already configured on this site it is used automatically; otherwise the BYOK key below. No provider selector, billing or marketplace.';
...
$string['actanotavailable'] = 'Session notes are off because neither Vertex AI nor a BYOK key is available.';
$string['actaprivacynote'] = 'Session notes use existing attendance logs. If a transcript already exists it is sent to Vertex AI when that is configured, otherwise to your BYOK LLM; recordings are not uploaded.';
$string['actaqueued'] = 'Session notes were queued. They will appear here shortly.';
$string['actashow'] = 'Show session notes on this activity';
$string['actashow_help'] = 'If enabled, people who can view session notes will see them on this activity. Uncheck to hide them here (including for teachers). Notes can still be generated when a teacher hangs up; they appear once this is checked again.';
...
$string['actatitle'] = 'Session notes';
...
$string['jitsi:viewacta'] = 'View session notes';
...
$string['privacy:metadata:jitsi_session_acta'] = 'Session notes generated after a class, including attendance copied from participating logs, the short summary and pending follow-ups.';
...
$string['privacy:metadata:jitsi_session_acta:userid'] = 'The ID of the teacher who ended the session and triggered the session notes.';
...
$string['privacy:metadata:vertexai'] = 'When a teacher generates an AI summary, quiz or transcription, the video recording is sent to Google Vertex AI (Gemini). When session notes are enabled and Vertex AI is already configured, an existing transcript (if any) and attendance display names are also sent there — recordings are not uploaded for session notes. The region is configurable in the plugin settings.';
$string['privacy:metadata:vertexai:attendance'] = 'Display names and connected minutes of attendees, sent when session notes use the existing Vertex AI setup.';
...
$string['privacy:metadata:vertexai:transcript'] = 'Existing session transcript text, sent to Vertex AI when session notes use the existing Vertex setup. Recordings are not uploaded for session notes.';
...
$string['task_generate_session_acta'] = 'Generate session notes';
